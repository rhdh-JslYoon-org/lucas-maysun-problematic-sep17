...
!!! info
    ...
    **Source Code Repository:** [https://github.com/rhdh-JslYoon-org/lucas-maysun-problematic-sep17](https://github.com/rhdh-JslYoon-org/lucas-maysun-problematic-sep17)

    **GitOps Repository:** [https://github.com/rhdh-JslYoon-org/lucas-maysun-problematic-sep17-gitops](https://github.com/rhdh-JslYoon-org/lucas-maysun-problematic-sep17-gitops)

# **Usage**

To access the lucas-maysun-problematic-sep17 application that was deployed using the Software Template, complete the following instructions:
...
If you are interested in seeing the deployed Kubernetes resources, all resources were deployed into your chosen namespace of lucas-maysun-problematic-sep17. You can access this namespace through the web console or via your CLI.
